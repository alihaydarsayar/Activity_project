		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Activity",
									"targetURL": "#asactivityactivityasayar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"asactivityactivityasayar-display": {
								"semanticObject": "asactivityactivityasayar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=as.activity.activityasayar",
									"url": sap.ui.require.toUrl("as/activity/activityasayar")
								}
							}
						}
					}
